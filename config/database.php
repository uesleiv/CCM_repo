	...
	*/
	...
	'connections' => [
		...
		'mysql' => [
			...
			'database'  => env('DB_DATABASE', env('OPENSHIFT_APP_NAME', 'uesval')),
			'username'  => env('DB_USERNAME', env('OPENSHIFT_MYSQL_DB_USERNAME', 'admindTHwGfz')),
			'password'  => env('DB_PASSWORD', env('OPENSHIFT_MYSQL_DB_PASSWORD', '7HC_NG-AQIx-')),
			'charset'   => 'utf8',
